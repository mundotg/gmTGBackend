...
def recreate_db():
    ...
    print("⚠️  Iniciando processo de reset do banco de dados...\n")
    ...
    try:
        ...
        print("🗑️  Todas as tabelas foram removidas com sucesso.")
...
if __name__ == "__main__":
    ...
    if env.lower() == "dev":
        print("⚙️  Ambiente de desenvolvimento detectado (ENV=dev)")
        recreate_db()
    else:
