...
async def transfer_stream(
    ...
    print(f"➡️ origem={id_connectio_origen}, destino={id_connectio_distino}")
    ...
    async def event_stream() -> AsyncGenerator[str, None]:
        ...
        async def put(event: str, data: str) -> None:
            ...
            try:
                ...
                print("⚠️ [PUT] Queue cheia, descartando mensagem antiga")
                try:
                    _ = q.get_nowait()
                except Exception:
                    pass
        ...
        try:
            ...
            print(f"⏱️ [STEP 11] Finalizado em {duration:.2f}s")
