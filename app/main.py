...
from app.routes import auth_routes, connection_routes, dbInfo_routes, dbstatistics_routes, delete_routes, query_routes, task_routes, user_routes, geral_routes
