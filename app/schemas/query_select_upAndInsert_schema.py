...
class JoinCondition(BaseModel):
    ...
    valueColumnType: Optional[str] = None   # tipo da coluna/valor: int, float, date, string...
...
class DistinctList(BaseModel):
    ...
    distinct_columns: List[str] = Field(..., title="Colunas Distintas", description="Lista de colunas para aplicar DISTINCT na consulta.",default_factory=list)
...
class CondicaoFiltro(BaseModel):
    ...
    value_type: Literal['string', 'number', 'date', 'boolean'] = Field("string", title="Tipo de Valor")
